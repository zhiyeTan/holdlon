...
class Medoo {
	...
	protected function table_quote($table = null) {
	...
	protected function where_clause($where) {
		...
		if (is_array($where)) {
			...
			$single_condition = array_diff_key($where, array_flip(array('AND', 'OR', 'GROUP', 'ORDER', 'HAVING', 'LIMIT', 'LIKE', 'MATCH')));
	...
	protected function select_context($join, &$columns = null, $where = null, $column_fn = null) {
		preg_match('/([a-zA-Z0-9_\-]*)\s*\(([a-zA-Z0-9_\-]*)\)/i', self::$table, $table_match);
	...
	public function select($join, $columns = null, $where = null) {
		...
		$query = $this -> query($this -> select_context($join, $columns, $where));
	...
	public function replace($columns, $search = null, $replace = null, $where = null) {
		...
		return $this -> exec('UPDATE ' . $this -> table_quote() . ' SET ' . $replace_query . $this -> where_clause($where));
	}
	...
	public function get($join = null, $columns = null, $where = null) {
		...
		$query = $this -> query($this -> select_context($join, $columns, $where) . ' LIMIT 1');
	...
	public function has($join, $where = null) {
		...
		$query = $this -> query('SELECT EXISTS(' . $this -> select_context($join, $column, $where, 1) . ')');
	...
	public function count($join = null, $column = null, $where = null) {
		$query = $this -> query($this -> select_context($join, $column, $where, 'COUNT'));

		return $query ? 0 + $query -> fetchColumn() : false;
	}

	public function max($join, $column = null, $where = null) {
		$query = $this -> query($this -> select_context($join, $column, $where, 'MAX'));
	...
	public function min($join, $column = null, $where = null) {
		$query = $this -> query($this -> select_context($join, $column, $where, 'MIN'));
	...
	public function avg($join, $column = null, $where = null) {
		$query = $this -> query($this -> select_context($join, $column, $where, 'AVG'));

		return $query ? 0 + $query -> fetchColumn() : false;
	}

	public function sum($join, $column = null, $where = null) {
		$query = $this -> query($this -> select_context($join, $column, $where, 'SUM'));
